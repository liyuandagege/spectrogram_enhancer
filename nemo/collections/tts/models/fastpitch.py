...
from nemo.collections.tts.losses.fastpitchloss import DurationLoss, EnergyLoss, MelLoss, PitchLoss #, SpectrogramPerceptualLoss, SpectrogramGradientLoss
...
class FastPitchModel(SpectrogramGenerator, Exportable, FastPitchAdapterModelMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        perceptual_loss_scale = loss_scale
        ...
        # self.perceptual_loss_fn = SpectrogramPerceptualLoss(loss_scale=perceptual_loss_scale)
        # self.gradient_loss_fn = SpectrogramGradientLoss(loss_scale=gradient_loss_scale)
        self.aligner = None
        if self.learn_alignment:
    ...
    def training_step(self, batch, batch_idx):
        ...
        # perceptual_loss = self.perceptual_loss_fn(spect_predicted=mels_pred, spect_tgt=mels)
        # gradient_loss = self.gradient_loss_fn(spect_predicted=mels_pred, spect_tgt=mels)
        # loss += perceptual_loss + gradient_loss
