...
from nemo.collections.asr.models.hybrid_asr_tts_models_plot_clip import ASRWithTTSModelClip
from nemo.core.config import hydra_runner
from nemo.utils import logging
from nemo.utils.exp_manager import exp_manager


@hydra_runner(config_path="../conf/asr_tts", config_name="hybrid_asr_tts")
def main(cfg):
    ...
    asr_model = ASRWithTTSModelClip(cfg.model, trainer=trainer)
